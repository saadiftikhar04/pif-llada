...
def main():
    ...
    for i, behavior_data in enumerate(tqdm(behaviors, desc="Processing")):
        ...
        try:
            ...
            output_baseline = generate(model, tokenizer, [input_ids[0]], steps=16, max_new_tokens=100, block_length=32, temperature=0.7)
            ...
            output_attack = generate(model, tokenizer, [input_ids_adv[0]], steps=16, max_new_tokens=100, block_length=32, temperature=0.7)
